...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.widget.setGeometry(QtCore.QRect(10, 20, 171, 191))
        ...
        self.comboBox_stop_bits = QtWidgets.QComboBox(self.widget)
        ...
        self.comboBox_baud_rate = QtWidgets.QComboBox(self.widget)
        ...
        self.comboBox_data_bits = QtWidgets.QComboBox(self.widget)
        ...
        self.comboBox_Port = QtWidgets.QComboBox(self.widget)
        self.comboBox_Port.setObjectName("comboBox_Port")
        self.gridLayout.addWidget(self.comboBox_Port, 0, 1, 1, 1)
        self.gridLayout.setColumnStretch(0, 2)
        self.gridLayout.setColumnStretch(1, 4)
        self.groupBox_2 = QtWidgets.QGroupBox(self.centralwidget)
        self.groupBox_2.setGeometry(QtCore.QRect(10, 240, 171, 141))
        self.groupBox_2.setObjectName("groupBox_2")
        self.widget1 = QtWidgets.QWidget(self.groupBox_2)
        self.widget1.setGeometry(QtCore.QRect(11, 24, 151, 111))
        self.widget1.setObjectName("widget1")
        self.gridLayout_2 = QtWidgets.QGridLayout(self.widget1)
        self.gridLayout_2.setContentsMargins(0, 0, 0, 0)
        self.gridLayout_2.setObjectName("gridLayout_2")
        self.radioButton_rev_ascii = QtWidgets.QRadioButton(self.widget1)
        ...
        self.radioButton_rev_hex = QtWidgets.QRadioButton(self.widget1)
        ...
        self.comboBox_rev_buff_size = QtWidgets.QComboBox(self.widget1)
        ...
        self.checkBox_save_file = QtWidgets.QCheckBox(self.widget1)
        ...
        self.pushButton_rev_clear = QtWidgets.QPushButton(self.widget1)
        ...
        self.groupBox_3.setGeometry(QtCore.QRect(10, 400, 171, 81))
        self.groupBox_3.setObjectName("groupBox_3")
        self.widget2 = QtWidgets.QWidget(self.groupBox_3)
        self.widget2.setGeometry(QtCore.QRect(11, 22, 151, 51))
        self.widget2.setObjectName("widget2")
        self.gridLayout_5 = QtWidgets.QGridLayout(self.widget2)
        self.gridLayout_5.setContentsMargins(0, 0, 0, 0)
        self.gridLayout_5.setObjectName("gridLayout_5")
        self.radioButton_send_ascii = QtWidgets.QRadioButton(self.widget2)
        ...
        self.radioButton_send_hex = QtWidgets.QRadioButton(self.widget2)
        ...
        self.pushButton_send_clear = QtWidgets.QPushButton(self.widget2)
        ...
        self.textBrowser_rev.setGeometry(QtCore.QRect(0, 50, 481, 271))
        self.textBrowser_rev.setObjectName("textBrowser_rev")
        self.widget3 = QtWidgets.QWidget(self.groupBox_4)
        self.widget3.setGeometry(QtCore.QRect(320, 20, 151, 22))
        ...
        self.comboBox_encode = QtWidgets.QComboBox(self.widget3)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.comboBox_baud_rate.setItemText(0, _translate("MainWindow", "1200"))
        self.comboBox_baud_rate.setItemText(1, _translate("MainWindow", "2400"))
        self.comboBox_baud_rate.setItemText(2, _translate("MainWindow", "4800"))
        self.comboBox_baud_rate.setItemText(3, _translate("MainWindow", "9600"))
        self.comboBox_baud_rate.setItemText(4, _translate("MainWindow", "14400"))
        self.comboBox_baud_rate.setItemText(5, _translate("MainWindow", "19200"))
        self.comboBox_baud_rate.setItemText(6, _translate("MainWindow", "38400"))
        self.comboBox_baud_rate.setItemText(7, _translate("MainWindow", "56000"))
        self.comboBox_baud_rate.setItemText(8, _translate("MainWindow", "57600"))
        self.comboBox_baud_rate.setItemText(9, _translate("MainWindow", "115200"))
        self.comboBox_baud_rate.setItemText(10, _translate("MainWindow", "128000"))
        self.comboBox_baud_rate.setItemText(11, _translate("MainWindow", "230400"))
        self.comboBox_baud_rate.setItemText(12, _translate("MainWindow", "256000"))
        self.comboBox_baud_rate.setItemText(13, _translate("MainWindow", "460800"))
        self.comboBox_baud_rate.setItemText(14, _translate("MainWindow", "600000"))
        self.comboBox_baud_rate.setItemText(15, _translate("MainWindow", "750000"))
        self.comboBox_baud_rate.setItemText(16, _translate("MainWindow", "921600"))
        self.comboBox_baud_rate.setItemText(17, _translate("MainWindow", "1000000"))
        self.comboBox_baud_rate.setItemText(18, _translate("MainWindow", "1500000"))
